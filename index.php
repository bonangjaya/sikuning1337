                ...
                <div class="card">
                    <div class="card-header">
                        <div class="text-center">
                            <h4><i class="fa fa-home"></i> Libernet Home</h4>
                        </div>                        
                    </div>					
                    <div class="card-body">						
						...
						<form @submit.prevent="runLibernet">
                            ...
                            <div class="row">
                                ...
                                <div class="col pt-2">
                                    <pre ref="log" v-html="log" class="form-control text-left" style="height: auto; width: auto; font-size:80%; background-image-position: center; background-color: #e9ecef "></pre>
                                </div>
                            </div>
                        </div>
                    </div>
