                        ...
                        <form @submit.prevent="saveConfig">
                            ...
                            <div v-if="config.temp.mode === 2" class="ssh-ssl pb-lg-2">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <label>SNI</label>
                                        <input type="text" class="form-control" placeholder="www.bug.com" v-model.number="config.temp.modes[2].profile.sni" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>UDPGW Port</label>
                            ...
                            <div v-if="config.temp.mode === 3" class="trojan pb-lg-2">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <label>SNI</label>
                                        <input type="text" class="form-control" placeholder="www.bug.com" v-model.number="config.temp.modes[3].profile.sni" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>UDPGW Port</label>
                            ...
                            <div v-if="config.temp.mode === 5" class="openvpn pb-lg-2">
                                ...
                                <div v-if="openvpn_auth_user_pass" class="form-row pb-lg-2">
                                    <div class="col-md-6">
                                        <label>Username</label>
                                        <input type="text" class="form-control" placeholder="Username" v-model="config.temp.modes[5].profile.username" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Password</label>
                                        <input type="text" class="form-control" placeholder="Password" v-model="config.temp.modes[5].profile.password" required>
                                    </div>
                                </div>
                                <div class="form-row pb-lg-2">
                                ...
                                <div v-if="config.temp.modes[5].profile.ssl" class="form-row pb-lg-2">
                                    <div class="col-md-4">
                                        <label>SNI</label>
                                        <input type="text" class="form-control" placeholder="www.bug.com" v-model="config.temp.modes[5].profile.sni" required>
                                    </div>
                                </div>
                            </div>
